...
export const translations = {
  en: {
    ...
    tradeHistoryDescription: 'Review executed trades and synced fills.',
    aiModels: 'AI Models',
    exchanges: 'Exchanges',
    ...
    create: 'Create',
    refresh: 'Refresh',
    tradeHistoryNoTraders: 'No traders available',
    tradeHistoryNoTradersDescription: 'Create or select a trader to view history.',
    tradeHistoryLoadError: 'Failed to load trade history.',
    tradeColumnTime: 'Time',
    tradeColumnSide: 'Side',
    tradeColumnAction: 'Action',
    tradeColumnQuantity: 'Quantity',
    tradeColumnRawDir: 'Exchange Dir',
    tradeColumnSignedQuantity: 'Signed Qty',
    tradeColumnLeverage: 'Leverage',
    tradeColumnPrice: 'Price',
    tradeColumnPnL: 'P&L',
    tradeColumnFee: 'Fee',
    tradeColumnSource: 'Source',
    tradeHistoryNoData: 'No trade history yet.',
    tradeHistoryRange: 'Showing {start}-{end} of {total} trades',
    previous: 'Previous',
    next: 'Next',
    pageSizeOption: '{count} / page',
    tradeSourceAuto: 'Auto Close',
    tradeSourceSync: 'Synced',
    tradeSourceAPI: 'Live',
    tradeActionOpenLong: 'Open Long',
    tradeActionOpenShort: 'Open Short',
    tradeActionCloseLong: 'Close Long',
    tradeActionCloseShort: 'Close Short',
  ...
  zh: {
    ...
    create: '创建',
    refresh: '刷新',
    tradeHistoryDescription: '查看已执行交易与同步的成交记录。',
    tradeHistoryNoTraders: '暂无交易员可供选择',
    tradeHistoryNoTradersDescription: '创建或选择交易员后可查看交易历史。',
    tradeHistoryLoadError: '加载交易历史失败。',
    tradeColumnTime: '时间',
    tradeColumnSide: '方向',
    tradeColumnAction: '操作',
    tradeColumnQuantity: '数量',
    tradeColumnRawDir: '原始方向',
    tradeColumnSignedQuantity: '带符号数量',
    tradeColumnLeverage: '杠杆',
    tradeColumnPrice: '成交价',
    tradeColumnPnL: '盈亏',
    tradeColumnFee: '手续费',
    tradeColumnSource: '来源',
    tradeHistoryNoData: '暂无交易历史。',
    tradeHistoryRange: '显示第 {start} - {end} 条，共 {total} 条交易',
    previous: '上一页',
    next: '下一页',
    pageSizeOption: '每页 {count} 条',
    tradeSourceAuto: '自动平仓',
    tradeSourceSync: '同步记录',
    tradeSourceAPI: '实时记录',
    tradeActionOpenLong: '开多',
    tradeActionOpenShort: '开空',
    tradeActionCloseLong: '平多',
    tradeActionCloseShort: '平空',
    autoTriggered: '自动触发',
